...
$("document").ready(function($){
  var nav = $('.index-three-search-bar');
...
// $("document").ready(function($){
//   var nav = $('.category-toggle button');

//   $(window).scroll(function () {
//     if ($(this).scrollTop() > 700) {
//         nav.addClass("category-sticky");

//     } else {
//         nav.removeClass("category-sticky");
//     }
